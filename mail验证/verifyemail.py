    ...
    for key in email_obj.keys():
        ...
        for need_verify in email_obj[key]:
            ...
            if send_from[0] == 250 or send_from[0] == 451:
                ...
                print(one_mail,file=result_url)
...
if __name__ == '__main__':
    mail_url=open('mail.txt','r')
    result_url=open('result.txt','w+')
    read_mail=mail_url.read().splitlines()
    for one_mail in read_mail:
        verify_istrue(one_mail)
